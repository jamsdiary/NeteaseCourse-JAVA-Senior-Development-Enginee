...
{
  path: '/cloudClassroomManager',
  component: Layout,
  name: '云课堂管理',
  icon: 'setting',
  authority: 'cloudClassroomManager',
  children: [{
    path: 'cloudClassroomCourseManager',
    component: _import('cloud/classroom/course/index'),
    name: '课程管理',
    authority: 'cloudClassroomCourseManager'
  }, {
    path: 'cloudClassroomOrderManager',
    component: _import('cloud/classroom/order/index'),
    name: '订单管理',
    authority: 'cloudClassroomOrderManager'
  }]
}

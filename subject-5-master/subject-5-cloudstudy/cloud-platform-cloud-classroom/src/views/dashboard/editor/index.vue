...
<!--      </el-button>-->
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row
      ...
      <el-table-column fixed="right" align="center" label="操作" width="150">
        <template scope="scope">
          <el-button v-if="courseManager_btn_edit" size="small" type="success" @click="handleUpdate(scope.row)">购买
          </el-button>
...
<!--          </el-button>-->
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" @click="cancel('form')">正在开发</el-button>
        <el-button v-else type="primary" @click="update('form')">正在开发</el-button>
      </div>
    </el-dialog>
  </div>
</template>

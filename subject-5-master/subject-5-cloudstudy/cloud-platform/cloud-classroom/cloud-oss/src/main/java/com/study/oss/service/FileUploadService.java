...
import com.study.oss.config.AliyunConfig;
...
public class FileUploadService {
    // 允许上传的格式
    private static final List<String> IMAGE_TYPE = Arrays.asList(".bmp", ".jpg",
            ".jpeg", ".gif", ".png");
    @Autowired
    ...
    public FileUploadResult delete(String objectName) {
        //除去域名前缀
        String fileName = objectName.replace(this.aliyunConfig.getUrlPrefix(),"");
